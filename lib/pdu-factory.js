...
exports.response = function(pdu, command_status, params, callback) {
    ...
    try {
        q = repdu.encode(pdu.header.command_id | 0x80000000, command_status, pdu.header.sequence_number, params, callback);
        return(q);
    } catch (e) {
        if (callback === undefined) {
            return e;
...
exports.bind_transceiver = function(params, callback, sequence_number) {
    return exports.fromStruct(Constants.commands.bind_transceiver, 0x00, sequence_number, params, callback);
}

exports.bind_transmitter = function(params, callback, sequence_number) {
    return exports.fromStruct(Constants.commands.bind_transmitter, 0x00, sequence_number, params, callback);
}

exports.bind_receiver = function(params, callback, sequence_number) {
    return exports.fromStruct(Constants.commands.bind_receiver, 0x00, sequence_number, params, callback);
}
