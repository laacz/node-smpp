 ...
 *
 * @param {String} format Format, according to which pack binary string
 * @param {Buffer} buffer Data (Buffer or String) to unpack
 *
 * @returns {Array} Unpacked array or single element, if unpacking only one value.
 * @throws {Error}
 */
 ...
 *
 * @param {String} format Format, according to which pack binary string
 * @param {Mixed},... Any number of params, according to format, which to pack.
 *
 * @returns {Buffer} Packed binary string
 * @throws {Error}
 */
